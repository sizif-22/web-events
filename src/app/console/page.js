...
const Console = () => {
  ...
  return isLoggedIn && isVerified ? (
    <div className="bg-[#0a0a0a] p-8 min-h-screen">
      <div className="w-full md:h-[30vh] h-[20vh] bg-[#2a2a2a] rounded-lg shadow-2xl shadow-[#ffffff50] border-[#ffffff50] border-2 relative">
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 w-4/5 bg-[#5959597a] backdrop-blur-sm rounded-lg shadow-lg p-6 border border-gray-200">
